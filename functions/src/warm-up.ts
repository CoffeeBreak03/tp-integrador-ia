...
export const handler: Handler = async (event) => {
  ...
  try {
    ...
    // Crear una imagen dummy mínima (1x1 pixel blanco en JPEG)
    ...
    const dummyBase64 = minimalJpeg.toString('base64');
    console.log('[WARM_UP] Sending dummy image to HF Space (' + dummyBase64.length + ' bytes)...');
